...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('assets/backend/js/modernizr/css-scrollbars.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/backend/js/common-pages.js') }}"></script>
</body>
